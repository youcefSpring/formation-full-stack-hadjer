    ...
    <style>
        ...
        *::after {
        ...
        :root {
            ...
            --gray-light: #e8e8f0;
            --white: #ffffff;
            --shadow: 0 20px 60px rgba(108, 62, 245, 0.15);
            --radius: 16px;
            --radius-sm: 10px;
        ...
        .btn-primary {
            background: var(--primary);
            color: var(--white);
            box-shadow: 0 8px 30px rgba(108, 62, 245, 0.35);
        }
        .btn-primary:hover {
            background: var(--primary-dark);
            transform: translateY(-3px);
            box-shadow: 0 12px 40px rgba(108, 62, 245, 0.5);
        }
        ...
        .hero::before {
            ...
            width: 700px;
            height: 700px;
            background: radial-gradient(circle, rgba(108, 62, 245, 0.15), transparent 70%);
            border-radius: 50%;
            pointer-events: none;
        }
        .hero::after {
        ...
        .hero-card .product-showcase .item {
            background: rgba(255, 255, 255, 0.04);
        ...
        .hero-card .product-showcase .item:hover {
            border-color: rgba(108, 62, 245, 0.3);
            transform: translateY(-4px);
            background: rgba(108, 62, 245, 0.06);
        }
        .hero-card .product-showcase .item .emoji {
            font-size: 2.6rem;
            display: block;
            margin-bottom: 8px;
        }
        .hero-card .product-showcase .item .name {
            font-weight: 600;
            font-size: 0.9rem;
        }
        .hero-card .product-showcase .item .price {
            font-size: 0.85rem;
            color: var(--secondary);
            font-weight: 600;
            margin-top: 4px;
        ...
        .newsletter {
            padding: 80px 0;
            background: linear-gradient(135deg, rgba(108, 62, 245, 0.08), rgba(0, 212, 170, 0.06));
    ...
    <section class="hero" id="hero">
        <div class="container">
            <div class="hero-content">
                <h1>
                    Discover <br />
                    <span class="highlight">Premium</span> Products <br />
                    for Your Life
                </h1>
                <p>
                    Shop the latest trends in fashion, electronics, and home —
                    curated just for you. Quality meets style at Nova.
                </p>
                ...
                <div class="hero-card">
                    <div class="product-showcase">
                        <div class="item">
                            ...
                            <div class="name">Wireless Pro</div>
                        ...
                        <div class="item">
                            <span class="emoji">📱</span>
                            <div class="name">Phone 15</div>
                            <div class="price">$999</div>
                        </div>
                        <div class="item">
                            <span class="emoji">💻</span>
                            <div class="name">Laptop Air</div>
        ...
        <div class="container">
            ...
            <div class="products-grid">
                ...
                <div class="product-card">
                    ...
                    <div class="product-name">Wireless Pro Buds</div>
                ...
                <div class="product-card">
                    <span class="product-emoji">⌚</span>
                    <div class="product-name">Smart Watch S8</div>
                ...
                <div class="product-card">
                    <span class="product-emoji">📱</span>
                    <div class="product-name">Phone 15 Pro</div>
                ...
                <div class="product-card">
                    <span class="product-emoji">💻</span>
                    <div class="product-name">Laptop Air M3</div>
                ...
                <div class="product-card">
                    ...
                    <div class="product-name">Aviator Shades</div>
    ...
    <section class="testimonials" id="testimonials">
        <div class="container">
            <div class="section-title">
                ...
                <p>Real reviews from real people who love Nova.</p>
            </div>

            <div class="testimonials-grid">
                <div class="testimonial-card">
                    <div class="stars">★★★★★</div>
                    <blockquote>“Absolutely love my new smart watch! The quality is incredible and shipping was lightning fast.”</blockquote>
                    <div class="author">
                ...
                <div class="testimonial-card">
                    <div class="stars">★★★★★</div>
                    <blockquote>“Nova has the best curated products. I’ve bought three items so far and every one has exceeded expectations.”</blockquote>
                    <div class="author">
                        <div class="avatar">MT</div>
                        <div class="info">
                            <div class="name">Marcus Taylor</div>
                ...
                <div class="testimonial-card">
                    <div class="stars">★★★★☆</div>
                    <blockquote>“Great customer service and beautiful packaging. My go-to store for premium lifestyle products.”</blockquote>
                    <div class="author">
                        <div class="avatar">SR</div>
                        <div class="info">
                            <div class="name">Sophie Reynolds</div>
    ...
    <section class="newsletter" id="newsletter">
        <div class="container">
            <div class="newsletter-wrapper">
                <h2>✉️ Join the <span style="background:linear-gradient(135deg,var(--primary-light),var(--secondary));-webkit-background-clip:text;-webkit-text-fill-color:transparent;">Nova</span> Community</h2>
                <p>Subscribe to get early access to new drops, exclusive discounts, and style inspiration.</p>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-brand">
                    ...
                    <p>Premium products delivered to your door. Quality, style, and innovation — all in one place.</p>
